...
import { Image, Pressable, ScrollView, StyleSheet, Switch, View, Platform } from 'react-native'
...
export default function CreateProductScreen ({ navigation, route }) {
  const initialProductValues = { name: null, description: null, price: null, image: null, order: null, productCategoryId: null, availability: null }
